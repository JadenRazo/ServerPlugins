...
/**
 * Delegating wrapper for ResultSet that forwards all calls to the wrapped ResultSet. Subclasses can
...
public class ResultSetWrapper implements ResultSet {
    ...
    /**
     * A ResultSet wrapper that also closes the associated Statement and Connection when closed.
     * This ensures connections are properly returned to the HikariCP pool.
     */
    public static class ConnectionAwareResultSet extends ResultSetWrapper {
        private final Statement statement;
        private final Connection connection;

        public ConnectionAwareResultSet(
                ResultSet delegate, Statement statement, Connection connection) {
            super(delegate);
